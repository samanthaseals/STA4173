...
Monday's lecture: [Two-Way ANOVA](https://github.com/samanthaseals/STA4173/blob/master/slides/L12.qmd)

Wednesday's lecture: [Profile Plots and Posthoc Testing](https://github.com/samanthaseals/STA4173/blob/master/slides/L11.qmd)
...
2. Perform the appropriate hypothesis test (typeset results from the ANOVA table in question 1) to demonstrate that the interaction is significant. Test at the $\alpha=0.05$ level.
...
5. Write a sentence or two to explain the analysis results to a non-statistician or non-data scientist.
