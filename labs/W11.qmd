...
Wednesday's lecture: [Multiple Regression](https://github.com/samanthaseals/STA4173/blob/master/slides/L16.qmd)
...
1. Model income as a function of work experience and level of education. What is the resulting regression model? (State as $\hat{y} = \hat{\beta}_0 + \hat{\beta}_1 x_1 + ...$)
